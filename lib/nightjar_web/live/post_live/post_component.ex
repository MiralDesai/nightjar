defmodule NightjarWeb.PostLive.PostComponent do
  use NightjarWeb, :live_component
  ...
  def handle_event("like", _, socket) do
    Nightjar.Timeline.inc_likes(socket.assigns.post)
    {:noreply, socket}
  end

  def handle_event("repost", _, socket) do
    Nightjar.Timeline.inc_reposts(socket.assigns.post)
    {:noreply, socket}
  end
end
